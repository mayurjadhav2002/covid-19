...
">
            ...
            <form action="" method="post">
            <ul class="ul">
  <li class="li"><input type="radio" name="ratio"  id="cb1" value="4" />
    <label for="cb1"><img src="https://bulma.io/images/placeholders/128x128.png" /></label>
  </li>
  <li class="li"><input type="radio" name="ratio" id="cb2" value="3" />
    <label for="cb2"><img src="https://bulma.io/images/placeholders/128x128.png" /></label>
  </li>
  <li class="li"><input type="radio" name="ratio"  id="cb3" value="1"/>
    <label for="cb3"><img src="https://bulma.io/images/placeholders/128x128.png" /></label>
  </li>
  <li class="li"><input type="radio" name="ratio"  id="cb4" value="2" />
    <label for="cb4"><img src="https://bulma.io/images/placeholders/128x128.png" /></label>
  </li>
...
<button class="button is-secondary" name="img">Submit</button>
<?php
if(isset($_POST['img'])){
   $result= mysqli_query($dbc, "UPDATE member SET profile2 = '".$_POST['ratio']."' WHERE Id = $id");
    if( $result){
        echo "updated";
    }else{
        echo "error";
