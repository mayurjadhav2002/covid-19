...
<div class="columns" style="margin-top: 5px;">
  ...
  <div class="column is-1 image is-128x128">



  <img src="images/2.png" class="is-rounded" alt="" 
...
<div class="column">
<textarea name="comment_content" id="comment_content" oninput="auto_grow(this)" placeholder="Would you like to Comment, Write here..." style="
    resize: none;
    overflow: hidden;
    min-height: 50px;
    width: 100% !important;
...
<br>
 ...
 <br>
		...
		<p class="uk-text-right">
            ...
            <button type="submit" name="submit" id="submit" class="btn btn-info button" value="Submit" class="uk-button uk-button-primary" type="button">Save</button>
        </p>
		</div>
   </form>
    </div>
...
<script>
	...
	$('h2#headline').text("Comment on <?php echo $row['posted_by']?>'s Post");
